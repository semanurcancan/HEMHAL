...
export const adminStore = defineStore("product", {
    ...
    state: () => {
        return {
            ...
            productHemhal: [] as Array<Product> as any,
            admin: [] as any,
            currentAdmin: {} as any,
            userList: [] as any,
            user: [
    ...
    actions: {
        ...
        async getProductHemdalFunc() {
            ...
            //const docSnap = await getDoc(doc(db, "product"));
        ...
        //CRUD POST
        async setProductHemhalFunc() {

        },

        async getAdmin(item: any) {
